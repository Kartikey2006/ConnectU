...
export default function LandingPage() {
  ...
  // Force client rendering to prevent SSR issues
  ...
  // Prevent hydration mismatch by rendering a loading state until client-side
  if (!mounted) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <HeroSection
        title="ConnectU"
        subtitle="Bridging the Gap Between Students and Alumni"
        description="Join thousands of students and alumni creating meaningful connections, sharing knowledge, and building successful careers together."
